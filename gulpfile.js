...
gulp.task('pack', gulp.parallel(() => {
  ...
  return gulp.src(['dist/**/*', '!dist/**/*.map', 'node_modules/webextension-polyfill/**/*', 'node_modules/underscore/**/*', 'icons/**/*', '!icons/**/*.svg', 'icons/**/*.min.svg', 'manifest.opera.json', 'LICENSE'], { base: '.' })
    .pipe(rename(path => {
